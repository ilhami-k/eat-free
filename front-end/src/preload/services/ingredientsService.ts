...
export function ingredientsService(): IIngredientsService {
  return {
    ...
    getIngredientById: (id: bigint) => ipcRenderer.invoke("ingredientsRepository:getIngredientById", id),
    ...
    updateIngredient: (id: bigint, data: { name?: string; kcal_per_100g?: number; protein_g_per_100g?: number; carbs_g_per_100g?: number; fat_g_per_100g?: number }) =>
      ipcRenderer.invoke("ingredientsRepository:updateIngredient", id, data),
    deleteIngredient: (id: bigint) => ipcRenderer.invoke("ingredientsRepository:deleteIngredient", id),
  };
}
