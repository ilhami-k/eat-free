...
export function journalService(): IJournalService {
  return {
    ...
    createJournalEntryWithTime: (user_id: bigint, recipe_id: bigint, servings_eaten: number, kcal: number, protein_g: number, carbs_g: number, fat_g: number, logged_at: Date) =>
